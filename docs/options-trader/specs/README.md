...
| **2** | ⭐ [**架构通俗讲解 — 一个场景跑通整个系统**](architecture-walkthrough.md) | **不懂软件架构的客户 / 业务方 / 偶尔回看不熟代码的工程师** | 北极星 §1 看完后, 想理解"系统怎么真实运转"时 |
| 3 | [2026-04-21 AI 自动盯盘 (完整版 v5)](2026-04-21-agentic-trading-redesign-design.md) | 想了解 <span class="term-agent">Agent 2</span> 持续决策细节的人 | 看完 1+2 后 |
| 4 | [2026-04-29 UI 重设计 v2](2026-04-29-ui-redesign-design.md) | 想了解前端架构的人 | 看完上面三个后 |
...
| ⭐ 架构通俗讲解 | **架构入口** — 用一个完整场景把任务队列 / 工人 / 4 Pool/Client / DB schema 全跑一遍, 不需要看代码 | 2026-05-06 最新 |
